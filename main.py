...
def credit():
    ...
    stdout.write(""+Fore.RED+" ╚═════╝╚═╝  ╚═╝╚══════╝╚═════╝ ╚═╝   ╚═╝   \n")
    stdout.write(""+Fore.RED+"╔═════════════════════════════╗\n")
    stdout.write(" "+Fore.LIGHTWHITE_EX+"https://discord.gg/SjNsjuxvVz\n")
    stdout.write(""+Fore.RED+"╚═════════════════════════════╝\n")
    stdout.write("\n")    
##############################################################################################
def layer7():
...
def title():
    ...
    stdout.write("             "+Fore.RED+"            ╚═══╦═══════════════════╦═══╝\n")
    stdout.write("             "+Fore.RED+"       ╚╦═══════╩═══════════════════╩═══════╦╝\n")
    stdout.write("             "+Fore.RED+"        ║ "+Fore.LIGHTCYAN_EX+" Welcome "+Fore.LIGHTWHITE_EX+"To The "+Fore.RED+"SATAN"+Fore.LIGHTWHITE_EX+" Tools Dos "+Fore.RED+"  ║                  \n")
    stdout.write("             "+Fore.RED+"        ║ "+Fore.BLUE+"  https://discord.gg/SjNsjuxvVz "+Fore.RED+"  ║                \n")
    stdout.write("             "+Fore.RED+"        ║  "+Fore.WHITE+" Type "+Fore.LIGHTGREEN_EX+"[help]"+Fore.WHITE+" View The Commands "+Fore.RED+"  ║                     \n")
    stdout.write("             "+Fore.RED+"        ╚═══════════════════════════════════╝         \n")
    stdout.write("\n")
##############################################################################################
def command():
    stdout.write(Fore.BLUE+"╔═══"+Fore.BLUE+"["+Fore.MAGENTA+"crystal"+Fore.BLUE+"●"+Fore.RED+"SATAN"+Fore.BLUE+"]"+Fore.BLUE+"\n╚══"+Fore.BLUE+"> "+Fore.WHITE)
    command = input()
